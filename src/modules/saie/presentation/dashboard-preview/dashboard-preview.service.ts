  ...
  public createViewModel(environment: NodeJS.ProcessEnv = process.env): DashboardViewModel {
    return {
      ...
      executiveRisks: [
        ...
        { limitation: "No RBAC", impact: "Role-based access is not implemented in Beta." },
        { limitation: "Process-local tenant isolation", impact: "Tenant context is validated but not authenticated or persisted." },
      ...
      approvalCenter: {
        ...
        items: [
          ...
          "Approval execution unavailable in Beta",
          "No action buttons",
        ],
      },
      safetyControls: [
      ...
      releaseTimeline: [
        ...
        { label: "SAIE-01.13 Enterprise Console Preview", status: "Complete" },
        { label: "SAIE-02.10 Production Readiness Review", status: "Current" },
      ],
      footer: {
